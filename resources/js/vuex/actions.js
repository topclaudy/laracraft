export default {
    theme: {
        LOADING: 'action-theme-loading',
        INDEX: 'action-theme-index',
        GET: 'action-theme-get',
        PUT: 'action-theme-put',
        CONFIGURE: 'action-theme-configure'
    },

    block: {
        LOADING: 'action-block-loading',
