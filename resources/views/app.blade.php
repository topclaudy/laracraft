...
<div id="laracraft" class="flex flex-wrap w-full" v-cloak>
    ...
    <nav class="nav-bar @yield('nav-bar-class')">
        <a href="{{ route('laracraft') }}"
           class="brand flex items-center flex-no-shrink text-primary mr-6 font-semibold text-xl tracking-tight">
    ...
    @section('footer')
        <footer class="text-grey-dark">
            <span class="mr-1">Laracraft © 2018-{{ date('Y') }}. Crafted with love by </span>
            <a href="http://www.awobaz.com" target="_blank">Awobaz Technologies Inc.</a>
        </footer>
    @show
